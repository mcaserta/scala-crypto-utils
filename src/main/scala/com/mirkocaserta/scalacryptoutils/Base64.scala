...
sealed case class EncodableString(string: String) {
  def encodeBase64: String = Base64.encode(string getBytes "UTF-8")
  def decodeBase64: Seq[Byte] = Base64.decode(string)
}

// this code blatantly stolen from
// https://github.com/tototoshi/scala-base64/blob/master/src/main/scala/Base64.scala
object Base64 {
  ...
  def encodeChar(i: Int): Char = encodeTable.charAt(i)
